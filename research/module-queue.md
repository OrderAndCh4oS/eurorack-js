...
| `shimmer` | done | research/modules/shimmer.md | Shimmer Reverb | effect | Pitch-shifted feedback reverb for octave clouds and ambient harmonic tails, beyond the current basic reverb. | Eventide pitch/reverb history, shimmer reverb algorithms, allpass/FDN references, pedal and module demos. | High |
