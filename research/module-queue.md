...
|-------------|--------|--------------|--------------|----------|--------------|------------------|------|
| `refrain` | implementing | research/modules/refrain.md | Refrain | sequencer | Phrase-aware deterministic variation, mutation, freeze, recall, and high-level musical control for Changes, Cascade, Arp, and other clocked modules without requiring scene programming. | Gamut/Multi Repetitor manuals and development notes, Marbles/Metropolix/Tetrapad-style controlled variation, loop and mutation workflows, deterministic PRNGs, phrase-quantized control, performance demos and reviews. | High |
