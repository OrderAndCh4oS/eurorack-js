...
| `prob-seq` | done | research/modules/prob-seq.md | Probability Sequencer | sequencer | Step sequencing with per-step probability, ratchets, skips, and conditional gates rather than fixed deterministic playback. | Elektron conditional trigs, Metropolis/Metropolix, Varigate, probability rhythm papers, performance demos. | Medium |
