...
| `chaos` | done | research/modules/chaos.md | Chaotic CV Generator | modulation | Non-repeating modulation from Lorenz/logistic-style systems, distinct from random and LFO modules. | Nonlinear dynamics papers, Sloths/chaos module manuals, chaos synth zines/articles, oscilloscope demos. | Medium |
