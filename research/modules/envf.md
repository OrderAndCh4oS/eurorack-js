...
- **Before remediation**: `inv` (cv) measured 0.35..10.00 V against -5..5 V; `env` (cv) measured 0.00..9.65 V against -5..5 V
- **After remediation**: Envelope and inverted outputs now declare 0..10 V; strict matrix passes.
