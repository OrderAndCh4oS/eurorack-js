 ...
 * validity gate, which drive a second oscillator/VCA voice for comparison.
 */
export default {
    ...
    state: {
        ...
        modules: [
            ...
            { id: 'sourceAmplifier', type: 'vca', row: 1, index: 3 },
        ...
        params: {
            ...
            sourceAmplifier: { ch1Gain: 0.8, ch2Gain: 0 },
        ...
        cables: [
            ...
            { fromModule: 'sequencer', fromPort: 'gate', toModule: 'sourceAmplifier', toPort: 'ch1CV' },
            { fromModule: 'sourceOscillator', fromPort: 'triangle', toModule: 'sourceAmplifier', toPort: 'ch1In' },
            { fromModule: 'sourceAmplifier', fromPort: 'ch1Out', toModule: 'tracker', toPort: 'audio' },
            ...
            { fromModule: 'trackedAmplifier', fromPort: 'ch1Out', toModule: 'out', toPort: 'L' },
