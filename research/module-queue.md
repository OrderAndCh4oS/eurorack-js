...
| `pitch-track` | done | research/modules/pitch-track.md | Pitch Tracker | utility | Converts monophonic audio pitch to 1V/oct CV and gate, enabling audio-controlled synth patches. | Autocorrelation/YIN pitch detection papers, guitar synth history, envelope/pitch follower modules, latency discussions. | High |
