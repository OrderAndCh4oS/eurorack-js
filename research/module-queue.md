...
| `vocoder` | done | research/modules/vocoder.md | Filter-Bank Vocoder | effect | Analysis/synthesis envelope transfer for speech-like filtering and carrier/modulator patches. | Classic vocoder articles, EMS/Sennheiser history, DAFX filter-bank vocoder material, hardware and plugin demos. | High |
