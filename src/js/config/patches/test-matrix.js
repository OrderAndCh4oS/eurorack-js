...
export default {
    ...
    state: {
        ...
        modules: [
            ...
            { id: 'matrix', type: 'matrix', row: 1, index: 2 },
            { id: 'vca', type: 'vca', row: 1, index: 3 },
            { id: 'out', type: 'out', row: 1, index: 4 }
        ],
        params: {
            lfo: { rateKnob: 0.35, waveKnob: 0 },
            ...
            vca: { ch1Gain: 0.75, ch2Gain: 0.75 },
            out: { volume: 0.5 }
        },
        cables: [
            { fromModule: 'vco', fromPort: 'triangle', toModule: 'matrix', toPort: 'in1' },
            { fromModule: 'vco', fromPort: 'pulse', toModule: 'matrix', toPort: 'in2' },
            { fromModule: 'lfo', fromPort: 'primary', toModule: 'matrix', toPort: 'in3' },
            { fromModule: 'matrix', fromPort: 'outA', toModule: 'vca', toPort: 'ch1In' },
            { fromModule: 'matrix', fromPort: 'outB', toModule: 'vca', toPort: 'ch1CV' },
