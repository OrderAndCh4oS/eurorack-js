...
export default {
    ...
    state: {
        ...
        params: {
            ...
            vcf: { cutoff: 0.18, resonance: 0.32 },
            vca: { ch1Gain: 0.9, ch2Gain: 0.8 },
            out: { volume: 0.5 }
        },
        cables: [
            { fromModule: 'vco', fromPort: 'triangle', toModule: 'vcf', toPort: 'audio' },
            { fromModule: 'vcf', fromPort: 'lpf', toModule: 'vca', toPort: 'ch1In' },
            { fromModule: 'joy', fromPort: 'x', toModule: 'vcf', toPort: 'cutoffCV' },
            { fromModule: 'joy', fromPort: 'y', toModule: 'vca', toPort: 'ch1CV' },
            { fromModule: 'joy', fromPort: 'x', toModule: 'scope', toPort: 'in1' },
            { fromModule: 'joy', fromPort: 'y', toModule: 'scope', toPort: 'in2' },
