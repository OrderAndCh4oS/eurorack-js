...
| Modulation | [lfo](modules/lfo.md), [quad-lfo](modules/quad-lfo.md), [rnd](modules/rnd.md), [envf](modules/envf.md), [func](modules/func.md), [adsr](modules/adsr.md), [slew](modules/slew.md), [ochd](modules/ochd.md), [chaos](modules/chaos.md) |
| Sequencing and pitch | [sh](modules/sh.md), [quant](modules/quant.md), [arp](modules/arp.md), [changes](modules/changes.md), [refrain](modules/refrain.md), [seq](modules/seq.md), [seq-switch](modules/seq-switch.md), [euclid](modules/euclid.md), [turing](modules/turing.md) |
